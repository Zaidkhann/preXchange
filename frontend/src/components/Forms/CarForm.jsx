      ...
      <form className="mx-auto flex w-full max-w-2xl flex-col gap-6 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8"
        ...
        <div className="border-b border-gray-100 pb-5">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Add information about the car you're selling
          </p>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <optgroup label="Popular Brands in India">
              ...
              <optgroup label="Other Popular International">
                <option>Jeep</option>
                <option>BYD</option>
                <option>Ford</option>
        ...
        <div className="space-y-3">
          <label className="text-sm font-semibold text-gray-800">
            Transmission <span className="text-cyan-600">*</span>
          </label>

          <div className="flex flex-wrap gap-3">
            <button
            value="Automatic"
              onClick={(e) => setTransmission(e.target.value)}
