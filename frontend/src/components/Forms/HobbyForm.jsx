            ...
            >
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        type="text"
                        maxLength={70}
                        placeholder="e.g. Pride and Prejudice by Jane Austen Novel"
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        maxLength={1000}
                        placeholder="Describe e.g. A sharp and witty romance about manners, class, and love in Regency England."
                        rows={5}
